...
const Registration = () => {
	...
	// State for dropdowns inside popup
	...
	const handleClosePopup = () => {
		...
		setOpenDropdown(null); // Close all dropdowns when closing the popup
	};
				...
				{paymentStatus === 'success' ? (
					<div>
						...
						<p className="text-xl mb-8">
							You have successfully registered for Hack Hub Hackathon.
						</p>
						<a
					...
					<div>
						...
						<p>
							Please try again or contact +91 87574 89128, +91 80917 48041 if the issue persists.
						</p>
					</div>
				) : null}
			</div>
	...
	// Modal component with 4 dropdowns
	const PolicyModal = () => {
		if (!isPopupVisible) return null;

		return (
			<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
				<div className="bg-[#222222] p-6 rounded-md w-1/2 max-h-[calc(100vh-180px)] overflow-y-auto">
					<h2 className="text-2xl font-bold mb-4">Important Info</h2>

					{/* Dropdown for Privacy Policy */}
					<div className="mb-4">
						<button
							className="w-full bg-[#39FF14] text-black px-4 py-2 rounded-md hover:bg-[#32CD32]"
							onClick={() => toggleDropdown('privacy')}
						>
							Privacy Policy
						</button>
						{openDropdown === 'privacy' && (
							<div className="mt-2 bg-[#333333] text-white p-4 rounded-md max-h-[calc(100vh-200px)] overflow-y-auto">
								<p>PRIVACY STATEMENT
									...
									If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at 21bph009@nith.ac.in or mailing us at: Village Bhamrara Post Office Bahli Teh Rampur, D.P.F. Bahli (69), Shimla, Himachal Pradesh - 172022
									...
									If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at 21bph009@nith.ac.in or by mail at Village Bhamrara Post Office Bahli Teh Rampur, D.P.F. Bahli (69), Shimla, Himachal Pradesh - 172022
					...
					{/* Dropdown for Terms and Conditions */}
					<div className="mb-4">
						<button
							className="w-full bg-[#39FF14] text-black px-4 py-2 rounded-md hover:bg-[#32CD32]"
						...
						{openDropdown === 'terms' && (
							<div className="mt-2 bg-[#333333] text-white p-4 rounded-md max-h-[calc(100vh-200px)] overflow-y-auto">
								<p>
									...
									This website is operated by Hack-Hub. Throughout the site, the terms “we”, “us” and “our” refer to Hack-Hub. Hack-Hub offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
									...
									You agree to indemnify, defend and hold harmless Hack-Hub and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
									...
									Questions about the Terms of Service should be sent to us at 21bph009@nith.ac.in .
					...
					{/* Dropdown for Refund Policy */}
					<div className="mb-4">
						<button
							className="w-full bg-[#39FF14] text-black px-4 py-2 rounded-md hover:bg-[#32CD32]"
							onClick={() => toggleDropdown('refund')}
						>
							Refund Policy
						</button>
						{openDropdown === 'refund' && (
							<div className="mt-2 bg-[#333333] text-white p-4 rounded-md max-h-[calc(100vh-200px)] overflow-y-auto">
								<p>Refund Policy
									...
									If you’ve done all of this and you still have not received your refund yet, please contact us at 21bph009@nith.ac.in.

									Sale items (if applicable)
									Only regular priced items may be refunded, unfortunately sale items cannot be refunded.

									Exchanges (if applicable)
									We only replace items if they are defective or damaged.  If you need to exchange it for the same item, send us an email at  and send your item to:21bph009@nith.ac.in 622 Manglam Electronic Market Jaipur Rajasthan India 302001.
					...
					<div className="mb-4">
						...
						{openDropdown === 'additional' && (
							<div className="mt-2 bg-[#333333] text-white p-4 rounded-md">
								<p>
									Address: <br />
									Village Bhamrara Post Office Bahli Teh Rampur, <br />
									D.P.F. Bahli (69), Shimla, Himachal Pradesh - 172022 <br />
									Email: <br />
									21bph009@nith.ac.in
								</p>
							</div>
					...
					<button
						...
						className="mt-4 bg-[#39FF14] text-black px-4 py-2 rounded-md hover:bg-[#32CD32]"
					>
						Close
					</button>
				</div>
		...
		<section className="bg-black text-[#39FF14] py-16 px-8 min-h-screen flex items-center justify-center">
			<div className="max-w-lg w-full bg-[#222222] p-8 rounded-lg shadow-lg">
				...
				<form onSubmit={handleSubmit}>
					...
					<button
						type="submit"
						className="w-full bg-[#39FF14] text-black py-3 rounded-md hover:bg-[#32CD32]"
						disabled={isPaymentProcessing}
					>
						{isPaymentProcessing ? 'Processing...' : 'Register & Pay'}
					</button>
				</form>
				...
				<div className="mb-4 text-center">
					<p>
						...
						<span
							onClick={() =>
								handleShowPopup('Privacy Policy content...')
							}
							className="cursor-pointer text-[#5588ca] underline">
							Privacy Policy
						</span>{' '}
						and{' '}
						<span
				...
				{/* Modal Popup */}
				{isPopupVisible && <PolicyModal />}

				{/* Full-screen message for payment status */}
